	...
	public static ArrayList<UriAndNumber> makeList(Model model, String nameOfListIn, String nameOfListOut) {
		...
		if (result.hasNext()) {
			while( result.hasNext() ) {
				...
				ListResources.add(new UriAndNumber(querySolution.getResource("class1").toString(), querySolution.getLiteral("usage").getInt())) ;
			}
		}
