...
public class MakeDescriptionModel {
	...
	public static OntModel  makeModel(ArrayList<UriListAndUriAndUriListAndNumber> listCombinationPropertiesClassRelationships,
	 ArrayList<UriListAndUriAndUriListList> listCombinationPropertiesClassRelationshipsPropertiesOfClasses,
	 ...
	 ArrayList<UriAndNumber> listMostUsedObjectProperty, ArrayList<UriAndNumber>listMostUsedDatatypeProperty, ArrayList<UriAndNumber> listMostUsedAnnotationProperty) {
		...
		// On s'occupe de toutes les propriétés liées aux classes concernées dans les relations

		// On récupère les domaines et ranges des propriétés les plus utilisées
		...
		for (UriListAndUriAndUriListList ressource : listCombinationPropertiesClassRelationshipsPropertiesOfClasses) {
			for (UriAndUriList ressource2 : ressource.getUriAndUriListList()) {
