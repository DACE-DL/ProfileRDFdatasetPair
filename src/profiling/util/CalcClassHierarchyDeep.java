...
public class CalcClassHierarchyDeep extends BaseBuiltin {

	@Override
	public String getName() {
		return "calcClassHierarchyDeep";
	}
	...
	private boolean doUserRequiredAction(Node[] args, int length, RuleContext context) {
		...
		if (node1.isURI()) {
			...
			"SELECT ?Class ?Subclass WHERE { <" + node1.getURI() + "> rdf:rest*/rdf:first ?element ." +
			" ?element dsp:asClass ?Class ." +
			" ?element dsp:asSubclass ?Subclass ." +		
			" } " 
			);
