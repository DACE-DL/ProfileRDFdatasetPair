...
public class CalcPropertyUsagePerObj extends BaseBuiltin {

	@Override
	public String getName() {
		return "calcPropertyUsagePerObj";
	}
	...
	private boolean doUserRequiredAction(Node[] args, int length, RuleContext context) {
		...
		String nameOfList = "listPropertyUsagePerObj";
		...
		Query query = QueryFactory.create(prefix + 
			"SELECT (?p AS ?property) (COUNT(DISTINCT ?o) AS ?usage) " +
			" WHERE { " +
