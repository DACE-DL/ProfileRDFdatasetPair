...
public class CalcPropertyUsagePerSubj extends BaseBuiltin {

	@Override
	public String getName() {
		return "calcPropertyUsagePerSubj";
	}
	...
	private boolean doUserRequiredAction(Node[] args, int length, RuleContext context) {
		...
		String nameOfList = "listPropertyUsagePerSubj";
		...
		Query query = QueryFactory.create(prefix + 
				"SELECT (?p AS ?property) (COUNT(DISTINCT ?s) AS ?usage) " +
				" WHERE { " +
