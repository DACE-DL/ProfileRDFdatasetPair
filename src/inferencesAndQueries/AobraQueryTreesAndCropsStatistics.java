...
public class AobraQueryTreesAndCropsStatistics {
	...
	public static void main(String[] args) throws Exception {
		...
		new AobraConf();
		String UserLanguage = AobraConf.preferredLanguage;
		...
		String topSpatial = "";
		ArrayList<AobraQueryObject> listQuery = new ArrayList<AobraQueryObject>();
		...
		listQuery.add(new AobraQueryObject(titleQuery, typeQuery, stringQuery));
		 ...
		 * listQuery.add(new AobraQueryObject(titleQuery, typeQuery,
		 * stringQuery));
		 * 
		 * titleQuery = "Test "; typeQuery = "SELECT"; stringQuery = prefix +
		 * "SELECT DISTINCT ?observation ?result" + " WHERE {" +
	...
	//	objectMapper.writeValue(new File("D:\\var\\www\\aobra\\queries\\queryForTreesAndCropsStatistics.json"), listQuery);
		...
		AobraCreateInferredModelAndRunQueries.InferencesAndQuery(listOntologies, listRules, topSpatial, listQuery);
